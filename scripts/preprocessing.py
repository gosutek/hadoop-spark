...
crime_2010_2019_path = (
    "hdfs://advdb-master:54310/user/master/crime_data/crimedata-2010-2019.csv"
)

crime_2020_pre_path = (
    "hdfs://advdb-master:54310/user/master/crime_data/crimedata-2020-present.csv"
)
...
crime_df = crime_df.withColumn(
    "Date Rptd", to_date(col("Date Rptd"), format="MM/dd/yyyy hh:mm:ss a")
)
crime_df = crime_df.withColumn(
    "DATE OCC", to_date(col("DATE OCC"), format="MM/dd/yyyy hh:mm:ss a")
)
crime_df.write.option("header", "true").csv(export_path, mode="overwrite")
